...
const HeroSec = () => {
  return (
    <>
      <section className="home-hero-section lg:bg-clip-hero-container relative h-auto lg:h-[max(620px,_calc(92vh-49px))] w-full pt-[30%] md:pt-[20%] lg:pt-0 max-lg:pb-[15%] text-white">
